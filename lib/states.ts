...
export const states: StateInfo[] = [
  { id: "01", name: "Alabama", abbreviation: "AL" },
  { id: "02", name: "Alaska", abbreviation: "AK" },
  { id: "04", name: "Arizona", abbreviation: "AZ" },
  { id: "05", name: "Arkansas", abbreviation: "AR" },
  { id: "06", name: "California", abbreviation: "CA" },
  { id: "08", name: "Colorado", abbreviation: "CO" },
  { id: "09", name: "Connecticut", abbreviation: "CT" },
  { id: "10", name: "Delaware", abbreviation: "DE" },
  { id: "11", name: "District of Columbia", abbreviation: "DC" },
